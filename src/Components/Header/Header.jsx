...
const Header = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-indigo-500 via-purple-500 to-blue-500 dark:bg-gray-900 w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
